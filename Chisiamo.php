...
<body bgcolor="#c1f3f6">
    ...
    <br>
    <br>
    <div class="siamoposition">
        <h1>Chi siamo?</h1>
        <h2>Siamo un piccolo canile che si occupa di curare e prendersi cura dei piccoli animali abbandonati e di chi non ha abbastanza tempo per prendersene cura di loro. In tanti anni abbiamo aiutato a trovare casa a tanti animali come la foto qua sotto che si tratta di zeus</h2>
        <img src="img/Chi siamo/Sfondoasso.jpg" class="imgsiamo">
        <img src="img/Chi siamo/pop.jpeg" class="imgsiamo">
        <h2>Zeus soli 2 anni è stato abbandonato in mezzo alla strada e se non fosse stato per un passante ora chissa dove si troverebbe, dopo 3 anni di accoglienza in canile ha trovato una famiglia che lo amasse per quello che è, come si può vedere nella seconda foto è cresciuto e ora è felice e si trova bene; non tutti potranno capire la sua felicità e quella che ha dato al piccolo padroncino della famiglia. Oggi sono 34 anni che il canile è aperto e aiuta altri piccola animali come Zeus a trovare famiglia e che vengono curati con i migliori medicinali</h2>
